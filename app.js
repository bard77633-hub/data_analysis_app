...
const MasterMode = ({ onExit, highScore, onUpdateScore }) => {
    ...
    if (phase === 'finished') {
        ...
        const isNewRecord = highScore > 0 && score > highScore; // Note: highScore is the *previous* high score before update if not updated in real-time, but simplified logic here.
